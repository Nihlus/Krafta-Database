...
{
	/// <summary>
	/// Represents an input temperature record for the G2 turbine.
	/// </summary>
	public struct TempG2 : ISqlRecord
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="Krafta.Records.TempG2"/> struct.
		/// Takes a raw line from "TEMPG2.SKV" as input.
		/// </summary>
		/// <param name="InRecord">In record.</param>
		public TempG2(string InRecord)
		{
		...
		{
			string baseInsertCommand = "INSERT INTO temp_G2 (date, time, rear_generator_bearing_temp, front_generator_bearing_temp," +
			...
			string baseSelectCommand = "SELECT date, time FROM temp_G2 WHERE date LIKE @date AND time LIKE @time";
