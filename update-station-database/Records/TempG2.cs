...
namespace Krafta.Records
{
	...
	public struct TempG2 : ISqlRecord
	{
		...
		{
			string baseInsertCommand = "INSERT INTO temp_G2 (date, rear_generator_bearing_temp, front_generator_bearing_temp," +
			...
			string baseSelectCommand = "SELECT date FROM temp_G2 WHERE date LIKE @date";
